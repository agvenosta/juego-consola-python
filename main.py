...
def main():
    nombre_jugador = input(
        "Bienvenido a la aventura en el espacio! Por favor ingresá tu nombre: "
    )
        ...
        while enemigo_actual.salud > 0:
            ...
            if accion == "atacar":
                ...
                if enemigo_actual.salud > 0:
                    ...
                    print(
                        f"{enemigo_actual.nombre} te atacó y te causó {dano_enemigo} de daño"
                    )
...
if __name__ == "__main__": # Nos asegura que solo podremos ejecutar este Scrypt desde el programa principal
    main()
